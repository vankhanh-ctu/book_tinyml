#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_MICRO_SPEECH_ESP_BUFF_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_MICRO_SPEECH_ESP_BUFF_H_
...
typedef struct ringbuf {
  ...
  volatile size_t fill_cnt;  /**< Number of filled slots */
